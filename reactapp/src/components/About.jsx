        ...
        <div className="grid gap-10 sm:px-10 md:gap-16 md:grid-cols-2">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              We craft spaces that inspire and endure, blending creativity with
              functionality. Our projects range from modern residences to
              sustainable commercial designs, each reflecting our commitment to
              innovation and quality. With a focus on client vision and
              meticulous detail, we transform ideas into reality. Discover how
              we integrate aesthetics with practicality to create timeless,
              impactful designs.
            </p>
          </div>
